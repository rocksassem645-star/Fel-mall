...
return [
    ...
    'Title (Arabic)' => 'Название (арабский)',
    'Title (Russian)' => 'Название (русский)',
    'Description (English)' => 'Описание (английский)',
    'Description (Arabic)' => 'Описание (арабский)',
    'Description (Russian)' => 'Описание (русский)',
    'Price ($)' => 'Цена ($)',
    'Add Product' => 'Добавить товар',
    'Edit Category' => 'Редактировать категорию',
    'Update the details below' => 'Обновите данные ниже',
    ...
    'Title AR' => 'Название (AR)',
    'Title RU' => 'Название (RU)',
    'Description EN' => 'Описание (EN)',
    'Description AR' => 'Описание (AR)',
    ...
    'Update details for' => 'Обновить данные для',
    'leave blank to keep current' => 'оставьте пустым, чтобы оставить текущее значение',
