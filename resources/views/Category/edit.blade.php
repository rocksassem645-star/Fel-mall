            ...
            <div class="col-md-10">
                <form action="{{ route('categories.update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title_en" class="form-control" value="{{ $result->title_en }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title_ar" class="form-control" value="{{ $result->title_ar }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title_ru" class="form-control" value="{{ $result->title_ru }}">
                        @error('title_ru')
