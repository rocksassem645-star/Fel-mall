                ...
                <div class="card-header py-4 text-white"
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 class="mb-0 fw-bold">{{ __('language.Product Details') }}</h5>
                                <small style="opacity:0.85;">{{ __('language.Viewing product') }} #{{ $result->id }}</small>
                            </div>
                        </div>
                        ...
                        <table class="table table-hover align-middle text-center mb-0">
                            <thead style="background:#f5f7fa;">
                                <tr>
                                    ...
                                    <th class="py-3 text-muted">{{ __('language.Price') }}</th>
                                    <th class="py-3 text-muted">{{ __('language.Quantity') }}</th>
